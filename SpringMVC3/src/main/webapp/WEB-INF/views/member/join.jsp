...
<div class="container">
  ...
  <div class="panel panel-default">
      ...
      <form name="frm" action="${contextPath}/memRegister.do" method="post">
         ...
         <table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
           ...
           <tr>
             ...
             <td colspan="2"><input id="memPassword1" name="memPassword1" onkeyup=" ()" class="form-control" type="password" maxlength="20" placeholder="비밀번호를 입력하세요."/></td>            
           </tr>
           <tr>
    ...
    <div class="panel-footer">Spring Framework_윤정선</div>
  </div>
</div>
</body>
</html>