...
public class MemberController {
	...
	/*@RequestMapping("/memImageUpdate.do")
	public String memImageUpdate( @RequestParam("memProfile") MultipartFile file, @RequestParam("memID") String memID) throws IOException {
		byte[] fileBytes = file.getBytes();
		
		int m = memberMapper.memProfileUpdate(memID, fileBytes);
		//
